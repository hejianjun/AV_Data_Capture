...
class TestImgProc:
    ...
    def test_face_crop_width(self, mock_face_center, mock_config):
        ...
        # 所以裁剪宽度为66 * 2 = 132
        assert result == (100 - 66, 0, 100 + 66, 200)  # (34, 0, 166, 200)
    ...
    def test_face_crop_height(self, mock_face_center, mock_config):
        ...
        # 从顶部开始裁剪，高度为300
        assert result == (0, 50, 200, 50 + 300)  # (0, 50, 200, 350)
    ...
    def test_cutImage(self, mock_face_crop_height, mock_face_crop_width, mock_cv2, mock_Image, mock_os, mock_config):
        ...
        assert mock_Image.open.called
        assert mock_face_crop_width.called
        assert mock_face_crop_height.called
